...
const UserDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-[#dcebea] to-[#b9d6d5] relative">
      ...
      <div className="absolute top-40 right-10 w-16 h-16 bg-[#b9d6d5]/60 rounded-full opacity-40 animate-pulse delay-1000"></div>
      <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-[#669a9b]/50 rounded-full opacity-30 animate-pulse delay-2000"></div>
      ...
      <div className="relative z-10 space-y-8">
          ...
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.name}
                onClick={handleClick}
                className="cursor-pointer bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-md border border-[#dcebea]/60 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Recent Activity */}
          <div className="lg:col-span-2 bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-md border border-[#dcebea]/60">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 rounded-xl border border-[#dcebea]/60 hover:bg-[#dcebea]/40 transition"
                  >
            ...
            {/* Progress */}
            <div className="bg-gradient-to-br from-[#dcebea] to-[#b9d6d5]/60 rounded-2xl p-6 shadow-md border border-[#dcebea]/50">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-[#669a9b]">
                    75%
                  </span>
                </div>
                <div className="w-full bg-[#dcebea] rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-[#669a9b] to-[#8dbbb9] h-2 rounded-full"
                    style={{ width: "75%" }}
                  ></div>
                </div>
                <div className="flex items-center space-x-2 pt-2">
                  <Star className="h-4 w-4 text-[#669a9b]" />
