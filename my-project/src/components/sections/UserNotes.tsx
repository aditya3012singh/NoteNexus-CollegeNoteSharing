...
const UserNotes: React.FC = () => {
  ...
  /* ---------------------- Main UI ---------------------- */
  return (
    <div className="min-h-screen bg-transparent py-10 relative">
      {/* Floating Background */}
     

      {/* Header */}
      <div className="bg-white/1  rounded-3xl p-8 shadow-xl mx-6  relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold text-white">
              Study <span className="text-[#80d5d6]">Notes</span>
            </h1>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center bg-tansparent text-white border  669a9b] px-4 py-2 rounded-xl">
      ...
      {/* Upload Form */}
      {showUploadForm && (
        <div className="bg-white/1  rounded-3xl p-8 shadow-xl mx-6 my-6 border border-[#dcebea]/10 relative z-10">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-white">Upload a Note</h2>
            <button
          ...
          <form onSubmit={handleUploadSubmit} className="space-y-5">
            <input
              ...
              className="w-full px-4 py-3 border border-[#dcebea]/20 rounded-xl focus:ring-2 focus:ring-[#8dbbb9]"
            />
            ...
            <div ref={dropdownRef} className="relative">
              <div
                ...
                className="w-full px-4 py-3 border border-[#dcebea]/20 rounded-xl bg-transparent cursor-pointer flex justify-between items-center"
              >
                <span>
              ...
              {dropdownOpen && (
                <div className="absolute z-20 bg-white/1 backdrop-blur-lg border border-[#dcebea]/60 rounded-xl mt-2 w-full max-h-48 overflow-y-auto shadow-md">
                  {branches.map((branch) => (
                    <label
                      key={branch}
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-[#dcebea]/20 rounded-xl"
            >
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-[#dcebea]/10 rounded-xl"
            >
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-[#dcebea]/20 rounded-xl file:mr-4 file:py-2 file:px-4 file:rounded-lg file:bg-[#dcebea] file:text-[#669a9b]"
            />
      ...
      {/* Filters */}
      <div className="bg-white/1 backdrop-blur-md p-8 mx-6 rounded-3xl shadow-md  my-6 relative z-10">
